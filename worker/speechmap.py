...
# Типовые галлюцинации whisper на тишине/музыке. Список двуязычный: модель на паузах
# выдаёт их то по-русски, то по-английски (она свободно уходит в перевод), поэтому
# ловим оба варианта — фильтр не должен зависеть от того, какой язык она выбрала.
HALLUCINATION_MARKERS = (
    "субтитры", "subtitles", "продолжение следует", "спасибо за просмотр",
    "thanks for watching", "dimatorzok", "редактор субтитров",
    "thank you.", "спасибо.", "you you", "ты ты",
)
